# Generated by Django 4.0.5 on 2022-12-05 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.TextField(blank=True, default='No intro.', null=True)),
                ('avatar', models.ImageField(default='blank-avatar.jpg', null=True, upload_to='')),
                ('avatar_url', models.URLField(default='https://res.cloudinary.com/dg1bym3ax/image/upload/v1669651547/blank-avatar.jpg', null=True)),
                ('avatar_public_id', models.CharField(blank=True, default=None, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.watchliststatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manga', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.manga')),
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.readliststatus')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='base.activitytype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
